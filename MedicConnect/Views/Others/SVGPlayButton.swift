...
private let kInnerRadiusScaleFactor = CGFloat(0.025)
...
@IBDesignable public class SVGPlayButton: UIButton {
    ...
    public var refTableView: UITableView?
    public var tickCount: CGFloat = 0
    
    override public func draw(_ rect: CGRect) {
        
        // Add shadow
        shadowLayer.path = UIBezierPath(roundedRect: rect, cornerRadius: rect.width / 2).cgPath
        ...
        let arcWidth: CGFloat = 3.0 //(rect.width * kInnerRadiusScaleFactor)
        ...
        progressTrackShapeLayer.isHidden = self.playing ? false : true
    ...
    private func presentForPlaying() {
        progressTrackShapeLayer.isHidden = false
    ...
    private func presentForPaused() {
        progressTrackShapeLayer.isHidden = true
