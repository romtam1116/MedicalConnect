...
#define TAG_RADIUS      9.f
#define TAG_HEIGHT      22.f
#define TAG_FONT        [UIFont fontWithName:@"Avenir-Book" size:12]
...
- (void)layoutSubviews {
    ...
    CGRect frame = CGRectMake(0, 0, 100, TAG_HEIGHT);
...
- (void)reloadTagSubviews {
    ...
    for (NSString *t in _tags) {
        ...
        tagView.layer.cornerRadius = TAG_RADIUS;
        ...
        tagLabel.layer.cornerRadius = TAG_RADIUS;
